  ...
  const renderCategoryItems = ({item}) => {
    return (
      <View
        ...
        <View
          style={[
            styles.categorySelectWraper,
            {
              backgroundColor: item.selected
                ? 'white'
                : foodAppColors.secondary,
            },
          ]}>
          <Feather
            style={[
              styles.categorySelectIcon,
              {color: item.selected ? '#000' : 'white'},
            ]}
            name={'chevron-right'}
            size={10}
          />
                  ...
                  <View>
                    <View style={styles.popularTopWraper}>
                      <MaterialCommunityIcons
                        name="crown"
                        color={foodAppColors.primary}
                        size={12}
                      />
                      <Text style={styles.popularTopText}>Top of the Week</Text>
                    </View>
                    <View style={styles.popularItemTitlesWraper}>
                      <Text style={styles.popularItemTitlesTitle}>
                        {item.title}
                      </Text>
                      <Text style={styles.popularItemTitlesWeight}>
                        Weight {item.weight}
                      </Text>
                    </View>
                  </View>
